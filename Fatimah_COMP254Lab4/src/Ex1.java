...
public class Ex1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(indexOfP(list, p1)); //0
        System.out.println(indexOfP(list, p2)); //1
        System.out.println(indexOfP(list, p3)); //2
        System.out.println(indexOfP(list, p4)); //3
